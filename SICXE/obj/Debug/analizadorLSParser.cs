...
namespace SICXE {
    ...
    public partial class analizadorLSParser : Parser
    {
        ...
        "FIX","FLOAT","HIO","NORM","SIO","TIO","ADD","ADDF","AND","COMP","LDA","LDB","LDX","STA",
        "TIX","JEQ","STL","JSUB","J","LDL","TD","RD","STCH","JLT","STX","LDCH","WD"
    };
        List<string> directivas = new List<string>(){
        "START","BYTE","WORD","END","RESB","RESW","BASE"
    };
        ...
        [RuleVersion(0)]
        public ProgramaContext programa(ref List<string> cod, ref List<List<string>> tab, ref List<string> forma, ref int reng, ref List<string> modosdir)
        {
            this.codObj = cod;
            this.tabSim = tab;
            this.formatos = forma;
            this.reng = reng;
            this.modosdir = modosdir;
            ...
            {
                indentificaError(_localctx.start.InputStream.ToString());
