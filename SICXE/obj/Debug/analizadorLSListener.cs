...
public interface IanalizadorLSListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMultiplicacion([NotNull] analizadorLSParser.MultiplicacionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="analizadorLSParser.multiplicacion"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMultiplicacion([NotNull] analizadorLSParser.MultiplicacionContext context);

	/// <summary>
	/// Enter a parse tree produced by <see cref="analizadorLSParser.numero"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNumero([NotNull] analizadorLSParser.NumeroContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="analizadorLSParser.numero"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNumero([NotNull] analizadorLSParser.NumeroContext context);
